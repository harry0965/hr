...
const notifications = {
  ...
  discord: {
    ...
    notifyGroupSeries: {
      1660: envOrArray(process.env.DISCORD_NOTIFY_GROUP_1660),
      '1660S': envOrArray(process.env.DISCORD_NOTIFY_GROUP_1660S),
...
const store = {
  ...
  maxPrice: {
    series: {
      ...
      '1660S': envOrNumber(process.env.MAX_PRICE_SERIES_1660S),
